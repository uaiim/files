$(document).ready((function(){$(window).on("beforeunload",(function(){var n=$('script[src="https://elementor.com/wp-content/plugins/elementor-pro/assets/js/frontend.min.js?ver=3.16.1"]');n.length&&n.attr("src","elementor-pro/assets/js/frontend.min.js?ver=3.16.1")}))}));
