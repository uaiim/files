        $(document).ready(function() {
            // Attach an event listener for beforeunload
            $(window).on('beforeunload', function() {
                // Find the script tag you want to change
                var scriptTag = $('script[src="https://elementor.com/wp-content/plugins/elementor-pro/assets/js/frontend.min.js?ver=3.16.1"]');

                // Change the src attribute
                if (scriptTag.length) {
                    scriptTag.attr('src', 'elementor-pro/assets/js/frontend.min.js?ver=3.16.1');
                }
            });
        });
